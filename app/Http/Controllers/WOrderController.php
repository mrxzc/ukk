...
class WOrderController extends Controller
{
    public function order() {
    	...
    	return view('waiter.master.order.index', compact('order','user'));
    }

    public function tambah() {
        $order = Order::all();
        $user = User::where('level_id','5')->get();
    	return view('waiter.master.order.tambah', compact('order','user'));
    }
    ...
    public function edit($id) {
    	return view('waiter.master.order.edit');
    }

    public function detail($id) {
    	$order = Order::find($id);	
    	return view('waiter.master.order.detail', compact('order'));
    }
    ...
    public function pilihmenu(){
        ...
        return view('waiter.master.order.pilih', compact('masakan','detailorder'));
    }
    ...
    public function transaksi(){
        ...
        $user = User::where('level_id','5')->get();
    	return view('waiter.master.transaksi.index', compact('transaksi','user'));
    }
    ...
    public function transaksi_update($order_id){
        ...
        $masakan = Masakan::All();
        return view('waiter.master.transaksi.detail', compact('masakan','transaksi','order','detailorder','user'));
    ...
    public function transaksi_detail($order_id){ 
        ...
        $detailorder = Detailorder::where('order_id',$order_id)->get();
        $masakan = Masakan::All();
        return view('waiter.master.transaksi.invoice', compact('masakan','transaksi','order','detailorder','user'));
    }
