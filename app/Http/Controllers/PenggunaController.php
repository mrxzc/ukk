...
class PenggunaController extends Controller
{
    public function pengguna() {
    	$pengguna = User::all();
    	return view('admin.master.pengguna.index', compact('pengguna'));
    }

    public function tambah() {
    	$pengguna = User::all();
    	return view('admin.master.pengguna.tambah', compact('pengguna'));
    }
    ...
    public function detail($id) {
    	...
    	return view('admin.master.pengguna.detail', compact('pengguna'));
    }
